...
object dstream_driverHa {
  ...
  val checkpointDir = "D:\\tmp\\sparkstreaming\\checkpoint-004"

  def functionToCreateContext(): StreamingContext = {
    val conf = new SparkConf().setAppName("dstream_driverHa").setMaster("local[2]")
    ...
    val lines: DStream[String] = ssc.socketTextStream("localhost",9999,StorageLevel.MEMORY_ONLY_SER)
